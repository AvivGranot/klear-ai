...
const navigation = [
  ...
  { name: "שיחות ושאלות", href: "/dashboard/escalations", icon: AlertCircle, badge: true },
  { name: "היסטוריית שיחות", href: "/dashboard/conversations", icon: MessageSquare },
              ...
              return (
                ...
                >
                  <item.icon className={cn(
                    "w-5 h-5",
                    isActive || isHighlight ? "text-[#25D366]" : hasBadge ? "text-orange-500" : "text-gray-400"
                  )} />
                  {item.name}
                  ...
                  {hasBadge && !isActive && (
                    <span className="mr-auto text-[10px] px-1.5 py-0.5 bg-orange-500 text-white rounded">0</span>
                  )}
                </Link>
              )
            })}
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden sm:block text-right">
                  ...
                  <span className="block text-xs text-gray-500">{user.role === 'owner' ? 'בעלים' : user.role === 'admin' ? 'מנהל' : 'מנהל'}</span>
                </div>
